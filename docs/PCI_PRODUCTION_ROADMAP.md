...
| ACPI archive v2 | In progress | AP-1 ABI/validator + AP-2 kernel producer in review; QEMU/merge open |
| Full Ring-3 uACPI | In progress | AP-3 isolated fail-closed build in review; callbacks/AML AP-4–AP-14 open |
