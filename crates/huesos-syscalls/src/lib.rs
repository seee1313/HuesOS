...
use huesos_abi::{
    ...
    ResourceUnmapArgs, VmarCreateChildArgs, VmarMapArgs, VmarOpArgs, WaitSetWaitArgs,
};
...
pub use callbacks::{
    ...
    set_resource_unmap_fn, set_shutdown_fn, set_thread_start_fn, set_vmar_map_fn,
    set_vmar_protect_fn, set_vmar_unmap_fn, set_yield_fn, HeapExtendFn, ProcessCreateFn,
    ProcessCreateInJobFn, ResourceMapFn, ResourceUnmapFn, ThreadStartFn, VmarMapFn, VmarOpFn,
};
...
pub fn dispatch(num: u64, a1: u64, a2: u64, a3: u64, a4: u64, a5: u64) -> SyscallResult {
    ...
    match syscall {
        ...
        S::ResourceUnmap => resource::sys_resource_unmap(a1 as *const ResourceUnmapArgs),
