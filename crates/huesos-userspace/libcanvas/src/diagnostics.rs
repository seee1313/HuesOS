...
pub fn user_pointer_guard_smoke_test() -> bool {
    ...
    let kernel_read = unsafe { raw::syscall2(Syscall::DebugWrite, KERNEL_HALF, 1) };
    let unmapped_write = unsafe { raw::syscall2(Syscall::VmoCreate, 4096, UNMAPPED_LOW_USER) };
    ...
    let readonly_write = unsafe { raw::syscall1(Syscall::FramebufferInfo, text_address) };
